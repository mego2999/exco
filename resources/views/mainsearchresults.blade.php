...
-->
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#exco">EXCO FILTERS</a></li>
        <li><a data-toggle="tab" href="#application">APPLICATIONS</a></li>
        <li><a data-toggle="tab" href="#cross">CROSS REFERENCE</a></li>
    </ul>

    <div class="tab-content">
        <div id="exco" class="tab-pane fade in active">
